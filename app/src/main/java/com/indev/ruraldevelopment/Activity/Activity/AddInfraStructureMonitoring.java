...
public class AddInfraStructureMonitoring extends AppCompatActivity {
    ...
    Button btnSubmit;
    String str_dmg,str_funtional,Installation,str_structureQi3,str_structureEffectiv,str_structureYes,str_structureshortfall_yes,str_structureEmuskanQ4,str_structureEmuskanQ5,str_structureEmuskanQ6,str_structureEmuskanQ7,str_structureEmuskanQ8,str_structureEmuskanQ9,str_structureEmuskanQ10,str_structureEmuskanQ11,str_structureEmuskanQ12;

    String str_structureEmuskanQ13,str_structureEmuskanQ14;
    LinearLayout ll_quesion,ll_quesionEmuskan,ll_quesion_newss;
    ...
    InfraStruMonitoringPojo InfraStruMonitoringPojo;
    ...
    String infra_iddd,SubResource_iddd,Subresource_name,infra_name,structure_name;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_infra_structure_monitoring_form);
        setTitle("Monitoring Infra Structure");
        ...
        if (sharedPrefHelper.getString("SubResource", "").equalsIgnoreCase("E-muskaan")) {
            ll_quesion.setVisibility(View.VISIBLE);
            ll_quesionEmuskan.setVisibility(View.GONE);
        } else {
            ll_quesion.setVisibility(View.VISIBLE);
            ll_quesionEmuskan.setVisibility(View.GONE);
        }
...
//                    InfraStruMonitoringPojo.setIs_there_a_kitchen_garden(str_structureEmuskanQ13);
                    InfraStruMonitoringPojo.setIs_it_Installation(Installation);
                    InfraStruMonitoringPojo.setIs_structure_damaged(str_dmg);
                    InfraStruMonitoringPojo.setVisibility_of_jubilant_brand(str_structureQi3);
                    InfraStruMonitoringPojo.setIs_structure_functional(str_funtional);
                    InfraStruMonitoringPojo.setMonitoring("monitoring");
                    ...
                    Intent intent = new Intent(AddInfraStructureMonitoring.this, InfraStraMonitoringList.class);
...
//        }
    ...
    private void launchCameraIntent() {
        Intent intent = new Intent(AddInfraStructureMonitoring.this, ImagePickerActivity.class);
...
//                        binding.ivCamera3.setClickable(false);
                        Toast.makeText(AddInfraStructureMonitoring.this, "You Can Capture Only Three Image", Toast.LENGTH_SHORT).show();
                    }
                    count++;
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddInfraStructureMonitoring.this);
    ...
    private void AllRadioButton() {
        ...
        rg_near_Installation.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    case R.id.rv_Installation_yes:
                        Installation = "Yes";
                        break;
                    case R.id.rv_Installation_No:
                        Installation = "No";
                        break;
                }
            }
        ...
        rg_near_structure3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    case R.id.rv_near_structure:
                        str_structureQi3 = "Yes";
                        break;
    ...
    private void initila() {
        ...
        rg_near_Installation = findViewById(R.id.rg_near_Installation);
        ...
        rg_near_structure3 = findViewById(R.id.rg_near_structure3);
